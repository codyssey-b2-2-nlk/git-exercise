...
- [ ] 3~5인 팀 구성과 전원의 Git 작업 참여: 위 팀원 표
- [ ] 팀 저장소와 Branch Protection Rule: TBD
- [ ] GitHub Flow 적용과 선택 이유:
  [`docs/CONTRIBUTING.md`](docs/CONTRIBUTING.md)
- [ ] PR 생성과 병합 2개 이상: 아래 PR 표
- [ ] 본인 PR을 제외한 실질적인 코드 리뷰 2개 이상: 아래 리뷰 표
- [ ] 리뷰 반영 1회 이상: 아래 리뷰 반영 표
- [ ] 커밋 메시지 컨벤션:
  [`docs/CONTRIBUTING.md`](docs/CONTRIBUTING.md)
- [ ] 충돌 해결 2회 이상, 비자명 충돌 1회 포함:
  [`docs/conflict-resolution.md`](docs/conflict-resolution.md)
- [ ] amend, reset --soft, revert, stash 전체 수행:
  [`docs/troubleshooting-log.md`](docs/troubleshooting-log.md)
- [ ] 협업 문서 3종 작성: [`docs/`](docs/README.md)
- [ ] 간단한 결과물과 팀원별 기여 커밋: TBD
- [ ] Git graph: TBD
